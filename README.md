...
| File | Sistema |
|---|---|
| `Anonimator-1.1.6-arm64.dmg` | Mac Apple Silicon (M1/M2/M3/M4) |
| `Anonimator-1.1.6-x64.dmg` | Mac Intel |
| `Anonimator-1.1.6-windows-x64-setup.exe` | Windows 10/11 a 64 bit |
| `Anonimator-1.1.6-linux-x64.AppImage` | Linux a 64 bit |
...
Esegui il file `Anonimator-1.1.6-windows-x64-setup.exe` per installare l'app.
...
```bash
chmod +x Anonimator-1.1.6-linux-x64.AppImage
./Anonimator-1.1.6-linux-x64.AppImage
```
