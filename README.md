...
| File | Sistema |
|---|---|
| `Anonimator-1.2.7-arm64.dmg` | Mac Apple Silicon (M1/M2/M3/M4) |
| `Anonimator-1.2.7-x64.dmg` | Mac Intel |
...
Esegui il file `Anonimator-1.2.7-windows-x64-setup.exe` per installare l'app.
...
```bash
chmod +x Anonimator-1.2.7-linux-x64.AppImage
./Anonimator-1.2.7-linux-x64.AppImage
```
