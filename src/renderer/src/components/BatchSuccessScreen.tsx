    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-lg space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <h2 className="text-2xl font-bold text-slate-800">Anonimizzazione completata</h2>
            ...
            {batchResults.map((result) => (
              <li key={result.filePath} className="flex items-start gap-3 px-4 py-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-slate-700 truncate" title={result.fileName}>
                    {result.fileName}
                  </p>
                  {result.error ? (
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="
              flex items-center justify-center gap-2
              w-full px-5 py-3 bg-white text-slate-600 font-medium rounded-xl
          ...
          <button
            ...
            className="
              flex items-center justify-center gap-2
              w-full px-5 py-3 bg-white text-slate-500 font-medium rounded-xl
