    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-700 font-medium mt-1 truncate" title={fileName}>
            {fileName}
          </p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 text-left">
          <p className="text-xs text-slate-400 mb-1">File salvato come</p>
          <p className="text-sm font-mono text-slate-700 break-all" title={outputPath}>
            {outputName}
          </p>
